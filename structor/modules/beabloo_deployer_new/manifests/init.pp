...
class beabloo_deployer_new {

  $path="/bin:/usr/bin"

  define commonClusterOozieFile($template = 'beabloo_deployer_new/oozie/common.erb') {
    file { $name:
      content => template($template)
    }
  }

  define commonClusterKettleFile($template = 'beabloo_deployer_new/kettle/common.erb') {
    file { $name:
      content => template($template)
    }
  }
  ...
  file { "/opt/data-integration/kitchen.sh":
    ...
    content => template('beabloo_deployer_new/kettle/kitchen.erb')
  }
  ->
  exec { 'chmod +x *.sh':
  ...
  file { "/opt/scripts/library.sh":
    ...
    content => template('beabloo_deployer_new/oozie/library.erb')
  }
  ->
  ...
  file { "/opt/data-integration/oozie/subversion/cluster.conf":
    ...
    content => template('beabloo_deployer_new/oozie/cluster.erb')
  }
  ->
  ...
  file { "/opt/data-integration/oozie/subversion/update_from_svn.sh":
    ...
    content => template('beabloo_deployer_new/oozie/update_from_svn.erb')
  }
  ->
  ...
  file { "/opt/data-integration/beabloo_kettle/subversion/cluster.conf":
    ...
    content => template('beabloo_deployer_new/kettle/cluster.erb')
  }
  ->
  ...
  file { "/opt/data-integration/beabloo_kettle/subversion/update_from_svn.sh":
    ...
    content => template('beabloo_deployer_new/kettle/update_from_svn.erb')
  }
  ->
  ...
  file { "/opt/data-integration/elfunctions/subversion/cluster.conf":
    ...
    content => template('beabloo_deployer_new/elfunctions/cluster.erb')
  }
  ->
  ...
  file { "/opt/data-integration/elfunctions/subversion/update_from_svn.sh":
    ...
    content => template('beabloo_deployer_new/elfunctions/update_from_svn.erb')
  }
  ->
