...
class beabloo_deployer_old_new {

  $path="/bin:/usr/bin"

  define commonClusterOozieFile($template = 'beabloo_deployer_old_new/new/oozie/common.erb') {
    file { $name:
      content => template($template)
    }
  }

  define commonClusterKettleFile($template = 'beabloo_deployer_old_new/new/kettle/common.erb') {
    file { $name:
      content => template($template)
    }
  }
  ...
  file { "/opt/data-integration/kitchen.sh":
    ...
    content => template('beabloo_deployer_old_new/common/kettle/kitchen.erb')
  }
  ->
  exec { 'chmod +x *.sh':
  ...
  file { "/opt/scripts/library.sh":
    ...
    content => template('beabloo_deployer_old_new/new/oozie/library.erb')
  }
  ->
  ...
  file { "/opt/data-integration/oozie/subversion/cluster.conf":
    ...
    content => template('beabloo_deployer_old_new/common/oozie/cluster.erb')
  }
  ->
  # Oozie old deployer
  file { "/opt/data-integration/oozie/subversion/common.properties":
    ensure => "present",
    content => template('beabloo_deployer_old_new/old/oozie/common.erb')
  }
  ->
  file { "/opt/data-integration/oozie/subversion/update_from_svn.sh.old":
    ensure => "present",
    content => template('beabloo_deployer_old_new/old/oozie/update_from_svn.erb')
  }
  ->
  ...
  file { "/opt/data-integration/oozie/subversion/update_from_svn.sh":
    ...
    content => template('beabloo_deployer_old_new/new/oozie/update_from_svn.erb')
  }
  ->
  ...
  file { "/opt/data-integration/beabloo_kettle/subversion/cluster.conf":
    ...
    content => template('beabloo_deployer_old_new/common/kettle/cluster.erb')
  }
  ->
  file { "/opt/data-integration/beabloo_kettle/subversion/common.properties":
    ensure => "present",
    content => template('beabloo_deployer_old_new/old/kettle/common.erb')
  }
  ->
  file { "/opt/data-integration/beabloo_kettle/subversion/update_from_svn.sh.old":
    ensure => "present",
    content => template('beabloo_deployer_old_new/old/kettle/update_from_svn.erb')
  }
  ->
  ...
  file { "/opt/data-integration/beabloo_kettle/subversion/update_from_svn.sh":
    ...
    content => template('beabloo_deployer_old_new/new/kettle/update_from_svn.erb')
  }
  ->
  ...
  file { "/opt/data-integration/elfunctions/subversion/cluster.conf":
    ...
    content => template('beabloo_deployer_old_new/new/elfunctions/cluster.erb')
  }
  ->
  ...
  file { "/opt/data-integration/elfunctions/subversion/update_from_svn.sh":
    ...
    content => template('beabloo_deployer_old_new/new/elfunctions/update_from_svn.erb')
  }
  ->
