...
public class KafkaRawLogProducerInterceptor {
    ...
    @Around("execution(* (@edu.ub.bigdata.loggateway.aspects.integration.KafkaRawLogProducer edu.ub.bigdata.loggateway.LogListener<INPUT, OUTPUT>+).onStoreLogObject(..))")
